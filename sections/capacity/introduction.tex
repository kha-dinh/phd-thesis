...
% Novelty1: life-cycle
\hdr{In-process capabilities for object life-cycles.}
...
\hdr{Simple and efficient reference monitoring.} \thename's coherent capability scheme also seamlessly incorporates a simple and efficient reference monitor design for in-process access control.
...
\hdr{Novel domain and \gls{pa} context binding scheme.}
