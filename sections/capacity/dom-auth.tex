...
\texttt{capac\_enter} is implemented as the following call gate, which is to be inlined to the domain switching sites:
...
\end{minted}
% \caption{\thename domain entry gate}
