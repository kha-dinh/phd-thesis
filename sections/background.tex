...
Lightweight context proposed retrofittign sub-process principal.

\subsection{Alternative approoaches}

\hdr{Language-based isolation}
...
While effective for managed languages, these techniques cannot be applied to low-level systems code written in C or C++, and they impose runtime constraints that complicate interaction with native libraries.
